  ...
  void createInvoice() async {
    ...
    try {
      ...
      Map<String, dynamic> body = {
        ...
        "discount_amount": widget.appState.discountTotal,
        "grand_total": widget.appState.total,
        "paid_amount": amountGivenWireTransfer+amountGivenCash+amountGivenCheque,
        "change_amount": amountGivenWireTransfer+amountGivenCash+amountGivenCheque-widget.appState.total,
